...
import { type GalaxyService, getGalaxyServices } from "../../components/AtomicCanvas/engine";
...
export function GalaxyPage() {
  ...
  }, [fetchServices, fetchStats, fetchKPIs, connectWs, disconnectWs]);
    ...
    <div className={styles.root}>
      <div className={styles.canvas}>
        ...
        <button
          ...
          onClick={handleDemo}
          title={demoActive ? t("galaxy_demo_stop_title") : t("galaxy_demo_start_title")}
        >
          {demoActive ? (
          ...
          <span>{demoActive ? t("galaxy_demo_stop") : "Demo"}</span>
        </button>
      </div>
      <SidePanel />
